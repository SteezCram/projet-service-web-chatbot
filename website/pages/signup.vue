            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form @submit.prevent="signup($event)" class="space-y-4 md:space-y-6" action="#">
                        ...
                        <input-text name="nickname" type="text" v-model.trim="nickname" placeholder="John Doe" required>
                            <template #label>
                                Surnom
                            </template>
                        </input-text>
                        ...
                        <input-text class="!mt-1" name="verifyPassword" type="password" v-model.trim="verifyPassword" required>
                            <template #label>
