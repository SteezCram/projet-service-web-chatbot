        ...
        <form @submit.prevent="sendMessage" class="absolute bottom-0 w-full">
            <container class="!min-h-0">
                ...
                <div class="flex items-center px-3 py-2 rounded-lg bg-gray-100 dark:bg-gray-900 shadow-md">
                    <button @click="addEmoji" ref="emojiButton" type="button" class="sm:p-2 text-gray-500 rounded-lg cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                    ...
                    <textarea @keypress="enterKeyHandler($event)" v-model.trim="message" rows="1" class="block mx-2 sm:mx-4 sm:p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-green-500 focus:border-primary-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" :placeholder="`Envoyer un message à ${bot_name}`"></textarea>
                    
                    <button ref="submitButton" type="submit" class="inline-flex justify-center sm:p-2 text-primary-600 rounded-full cursor-pointer hover:bg-primary-100 dark:text-primary-100 dark:hover:bg-primary-600">
